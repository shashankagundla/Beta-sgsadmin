    ...
    */
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        */
        ...
        // $postinlinetw = filter_input(
        //     INPUT_POST, "inline_tw", FILTER_VALIDATE_INT
        // );
        ...
        $_CONFIG['upload_reject_extension'] = array_filter(explode(",", $postupload_reject_extension));

        $_CONFIG['upload_allow_type'] = array_filter(explode(",", $postupload_allow_type));
