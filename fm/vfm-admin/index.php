...
<body class="skin-<?php print $skin; ?> fixed sidebar-mini admin-body <?php echo $rtlclass; ?>" data-target="#scrollspy" data-spy="scroll">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            if (!empty($success) && !empty($status)) {
                ...
                $bgcolor = ( ($status == 'yep') ? 'bs-callout-success' : 'bs-callout-danger' ); ?>
                <div class="alert bs-callout <?php echo $bgcolor; ?> fade" role="alert" id="bs-response">
                    <i class="fa <?php echo $icona; ?>"></i> <?php echo $success; ?>
    ...
    <script type="text/javascript" src="admin-panel/js/admin.js"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            /**
